...
import cn.itcast.musicapp.util.ArtworkUtils;
...
//        holder.imageView1_icon.setImageBitmap(MediaUtils.getArtwork(context,mp3Info.getId(),mp3Info.getAlbumId(),true,true));
        holder.imageView1_icon.setImageBitmap(ArtworkUtils.getArtwork(context, mp3Info.getId(), mp3Info.getAlbumId(), true));
